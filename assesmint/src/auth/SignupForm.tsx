          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* <div>
              ...
              <div className="relative">
                <select
                  ...
                  value={formData.role}
                  onChange={handleChange}
                  className={`w-full pl-3 pr-10 py-2 border ${errors.role ? 'border-red-500' : 'border-gray-300'} rounded-md focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition duration-200 appearance-none`}
                >
            ...
            <div className="flex items-center">
              ...
              <label htmlFor="agreeToTerms" className="ml-2 block text-sm text-gray-700">
                I agree to the{' '}
                <a href="#" className="text-[#8382FA] hover:text-emerald-800">terms</a>
                {' '}and{' '}
