            ...
            <div className="flex items-center">
              <Avatar.Root className="flex-shrink-0">
                <Avatar.Image
                  ...
                  alt="User"
                />
                <Avatar.Fallback className="h-8 w-8 rounded-full bg-violet-600 flex items-center justify-center text-white font-semibold">
                  M
                </Avatar.Fallback>
              </Avatar.Root>
              <div className="ml-4">
            ...
            <div className="flex items-center space-x-4">
              <div className="relative">
                <input
                  ...
                  className="w-64 pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-violet-500 focus:border-transparent"
                />
